...
public class RomanToArabic {
    ...
    public static Hashtable<ParseTableCell, Production> getParseTable() {
        ...
        parseTable.put(new ParseTableCell("thousands","M"), new Production("thousands","M t2"));
        ...
        parseTable.put(new ParseTableCell("t2","M"), new Production("t2","M"));
        ...
        parseTable.put(new ParseTableCell("t3","M"), new Production("t3","M"));
        ...
        parseTable.put(new ParseTableCell("hundreds","C"), new Production("hundreds","C h2"));
        parseTable.put(new ParseTableCell("hundreds","D"), new Production("hundreds","D h5"));
        ...
        parseTable.put(new ParseTableCell("h2","C"), new Production("h2","C h3"));
        parseTable.put(new ParseTableCell("h2","D"), new Production("h2","D"));
        parseTable.put(new ParseTableCell("h2","M"), new Production("h2","M"));
        ...
        parseTable.put(new ParseTableCell("h3","C"), new Production("h3","C"));
        ...
        parseTable.put(new ParseTableCell("h5","C"), new Production("h5","C h6"));
        ...
        parseTable.put(new ParseTableCell("h6","C"), new Production("h6","C h3"));
        ...
        parseTable.put(new ParseTableCell("tens","X"), new Production("tens","X g2"));
        parseTable.put(new ParseTableCell("tens","L"), new Production("tens","L g5"));
        ...
        parseTable.put(new ParseTableCell("g2","X"), new Production("g2","X g3"));
        parseTable.put(new ParseTableCell("g2","L"), new Production("g2","L"));
        parseTable.put(new ParseTableCell("g2","C"), new Production("g2","C"));
        ...
        parseTable.put(new ParseTableCell("g3","X"), new Production("g3","X"));
        ...
        parseTable.put(new ParseTableCell("g5","X"), new Production("g5","X g6"));
        ...
        parseTable.put(new ParseTableCell("g6","X"), new Production("g6","X g3"));
        ...
        // row ones
        parseTable.put(new ParseTableCell("ones","I"), new Production("ones","I k2"));
        parseTable.put(new ParseTableCell("ones","V"), new Production("ones","V k5"));
        ...
        // row k2
        parseTable.put(new ParseTableCell("k2","I"), new Production("k2","I"));
        parseTable.put(new ParseTableCell("k2","V"), new Production("k2","V"));
        parseTable.put(new ParseTableCell("k2","X"), new Production("k2","X"));
        ...
        // row k3
        parseTable.put(new ParseTableCell("k3","I"), new Production("k3","I"));
        ...
        // row k5
        parseTable.put(new ParseTableCell("k5","I"), new Production("k5","I k6"));
        ...
        // row k6
        parseTable.put(new ParseTableCell("k6","I"), new Production("k6","I k3"));
